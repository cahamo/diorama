...
// Feedback LED flash times
#define FEEDBACK_REPORT_FLASH_OFF_TIME 50
#define FEEDBACK_REPORT_FLASH_ON_TIME 150
#define FEEDBACK_REPORT_FLASH_PAUSE_TIME 150
#define FEEDBACK_REPORT_FLASH_COUNT 4
...
void flashFeedbackLED(RGBColour colour) {
  feedbackLED.flash(
    colour,
    FEEDBACK_REPORT_FLASH_COUNT,
    FEEDBACK_REPORT_FLASH_OFF_TIME,
    FEEDBACK_REPORT_FLASH_ON_TIME,
    FEEDBACK_REPORT_FLASH_PAUSE_TIME
  );
}
